...
@section('title', 'Tambah Zone')
@section('page-title', 'Tambah Zone')
...
<div class="card">
    <div class="card-header d-flex align-items-center">
        <div class="p-2 rounded text-white me-2" style="background:linear-gradient(135deg,#10b981,#047857)">
            <i class="bi bi-plus-square-fill"></i>
        </div>
        <span>Form Zone Baru</span>
    </div>
    <div class="card-body">
        <form action="{{ route('admin.zones.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="name" value="{{ old('name') }}"
                    class="form-control @error('name') is-invalid @enderror" placeholder="Contoh: Mountain" required>
            ...
            <div class="mb-3">
                ...
                <textarea name="description" rows="4"
                    ...
                    placeholder="Deskripsi singkat zone...">{{ old('description') }}</textarea>
